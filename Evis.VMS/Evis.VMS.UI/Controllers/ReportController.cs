...
namespace Evis.VMS.UI.Controllers
{
    public class ReportController : Controller
    {
        ...
        public ActionResult PrintVisitorsDetailsReport(string searchData)
        {
            Reports.DataSet.VisitorsDetailsDataSet visitorsDetailsDataSet = new Reports.DataSet.VisitorsDetailsDataSet();

            var result = _visitorDetailsReportHelper.PrintVisitorData(searchData);
        ...
        public ActionResult PrintVisitorsDetailsReportExcel(string searchData)
        {
            Reports.DataSet.VisitorsDetailsDataSet visitorsDetailsDataSet = new Reports.DataSet.VisitorsDetailsDataSet();
